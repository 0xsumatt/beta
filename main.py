...
class beta_calculator:
    ...
    def calc_beta(self):
        ...
        price_ticker_1 = pd_dtr.get_data_yahoo(self.ticker_1,start = self.start_date,end = self.end_date)
        price_ticker_2= pd_dtr.get_data_yahoo(self.ticker_2,start = self.start_date,end = self.end_date)
